void upload_ESP(){
  char INSERT_DATA[] = "%02d/%02d/%02d,%02d:%02d:%02d,%s,%s,%s,%d,%d,%s,%s,%s,%s,%s\r";
  char query[256];
...
//  dtostrf(alti,1,2,temp6);
  ...
  sprintf(query, INSERT_DATA, year, month, day, hour, minute, second, temp1, temp2, temp3, humidity, valCO2, temp7, temp8, temp9, temp10, temp11);
  Serial.print("query = ");
